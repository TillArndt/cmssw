...
class MyPatJetAnalyzer : public edm::BasicAnalyzer {

 public:
  /// default constructor
  MyPatJetAnalyzer(const edm::ParameterSet& cfg, TFileDirectory& fs);
  MyPatJetAnalyzer(const edm::ParameterSet& cfg, TFileDirectory& fs, edm::ConsumesCollector&& iC);
  /// default destructor
  virtual ~MyPatJetAnalyzer(){};
